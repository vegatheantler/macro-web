...
animation: spin-two 2s infinite linear;
  ...
  <title>COMPATIBILITY ERROR</title>
  ...
  <div class="container">
    ...
    <p>This web application is compatible with FIREFOX AND CHROME.</p>
    <p>Chrome link<a href="https://www.google.com/chrome/" target="_blank">Google Chrome</a></p>
    <p>Firefox link<a href="https://www.mozilla.org/en-US/firefox/new/" target="_blank">Firefox</a></p>
  </div>
<?php
  exit;
}

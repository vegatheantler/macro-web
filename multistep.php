...
<head>
	...
	<body onload="myFunction()" style="background:gray;">
	</head>
	<!-- multistep form -->
				...
				<div class="col-md-12">
					<form id="msform" name="msform" method="post" action="functions/processreport.php" enctype="multipart/form-data">
						...
						<fieldset class="general-info">
							...
							<span class="tooltipContainer"><input id="cityOfOffense" class="col-xs-12 col-sm-12" type="text" name="cityOfOffense" placeholder="City" required /> <span class="tooltiptext">The city or district the crime took place.</span></span>
							<span class="tooltipContainer"><input id="barangayOfOffense" class="col-xs-12 col-sm-6" type="text"  name="barangayOfOffense" placeholder="Barangay"/><span class="tooltiptext">Optional</span></span>
							<span class="tooltipContainer"><input id="streetAddressOfOffense" class="col-xs-12 col-sm-6" name="streetAddressOfOffense" type="text"   placeholder="Street"/><span class="tooltiptext">Optional</span></span>
						...
						<fieldset>
							...
							<h3 class="fs-subtitle"><p>If you have a digital photograph that's relevant to this report (for example, a photo taken with your phone) you can upload it here. Please ensure the image is in .jpg or .jpeg format and that it’s no bigger than 2 MB in size.</p><br>
								...
								<div class="duplicates">
									<div id="evidence0" class="hidden">
										<input name="evidence[]" type="file" class="col-xs-12">
									</div>
								</div>
								<input type="button" name="previous" class="previous action-button" value="Previous" />
								<input type="button" name="next" class="next action-button" value="Next" />
							...
							<fieldset>
								...
								<p class="noHighlight">
									<input type="text" id="password" name="password" class="byTwo" placeholder="Password for your Report" id="password" required/></p>
									<p class="noHighlight">
										<input type="checkbox" name="checkbox" id="agreement" required/>&nbsp;<label for="agreement" class="byThree">I agree to the terms and conditions.</label></p>
										<hr>

...
<html lang="en" dir="ltr">
  ...
  <body>
    <form action="functions/addKeepsafeFunc.php" method="POST" enctype="multipart/form-data">
    <div class="container">
<br>
        <div class="col-xs-12"><input type="text" id="" class="form-control"  name="sidebarName" placeholder="SIDEBAR NAME......" required><br>
        </div>

...
<script type="text/javascript">
  var count = 10; // Timer
  var redirect = "../addKeepsafe.php"; // Target URL
...
<div id="master-wrap">
  <div id="logo-box">
    ...
    <div class="notice animated fadeInUp">
      <p class="lead">A Keep Safe Tips has been successfuly Added!</p>
      <a class="btn animation" href="../addKeepsafe.php">&larr; Back</a>
    </div>

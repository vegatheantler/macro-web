...
<script type="text/javascript">
  var count = 10; // Timer
  var redirect = "../addWanted.php"; // Target URL
...
<div id="master-wrap">
  <div id="logo-box">
    ...
    <div class="notice animated fadeInUp">
      <p class="lead">A wanted personality has been successfuly added!</p>
      <a class="btn animation" href="../addWanted.php">&larr; Back</a>
    </div>

...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta property="og:image" content="https://codepen.io/redfrost/pen/KzegWQ/image/large.png" itemprop="thumbnailUrl">
  <meta property="og:title" content="Redirect Countdown">
  <meta property="og:url" content="https://codepen.io/redfrost/details/KzegWQ">
  <meta property="og:site_name" content="CodePen">
  <meta property="og:description" content="Quick redirection countdown....">
    <title></title>
...
<script type="text/javascript">
  var count = 10; // Timer
  var redirect = "../updateUnsolved.php"; // Target URL
...
<div id="master-wrap">
  <div id="logo-box">
    ...
    <div class="notice animated fadeInUp">
      <p class="lead">A Featured Crime has been successfuly updated!</p>
      <a class="btn animation" href="../updateUnsolved.php">&larr; Back</a>
    </div>
